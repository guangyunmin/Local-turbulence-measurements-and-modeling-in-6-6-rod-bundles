...
f_g = 0.93;  % Base flow coefficient
...
title({'1 / 4 edge subchannel (type A)', '<\itW>=\rm0.389 m/s'}, 'FontName', 'Times New Roman', 'FontSize', 14);
...
text(max_X-W/2, max_Y, max_F+0.4,  sprintf('\\it f\\rm_{c,\\iti}: %.2f', max_F), ...
    'FontSize', 14, 'FontName', 'Times New Roman', 'Color', 'r', 'Interpreter', 'tex');
scatter3(P/2, 0, 0.98, 200, [0.5, 1, 1], 'filled'); 
text(P/2, -3.0, 0.93+0.4,sprintf('\\it f\\rm_{g,\\iti}: %.2f', 0.93), ...
