...
P2_x = linspace(min(P2_points(:,1)), max(P2_points(:,1)), 200);
P2_y = linspace(min(P2_points(:,2)), max(P2_points(:,2)), 200);
...
title({'1 / 2 corner subchannel,' '<\itW>=\rm0.389 m/s'}, 'FontName', 'Times New Roman', 'FontSize', 14);
...
text(max_X-0.4, max_Y+0.2, max_F+0.4,  sprintf('\\it f\\rm_{c,\\iti}: %.2f', max_F), ...
