...
for kk=1:size(f_g1,2)
    for kj=1:size(f_01,2)
        ...
        title('1 / 4 edge subchannel (type A)', 'FontName', 'Times New Roman', 'FontSize', 14);
        ...
        text(P/2, -2.3, 0.93+0.4,sprintf('\\it f\\rm_{g}: %.2f', 0.93), ...
...
save('Data_central.mat','FO','FG','Fina_avg')
